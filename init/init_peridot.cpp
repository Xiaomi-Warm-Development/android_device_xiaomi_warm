...
void vendor_load_properties() {
    ...
    if (region == "IN") {
        device = "peridot";
        brand = "POCO";
        description = "peridot_global-user 14 UKQ1.240624.001 OS2.0.102.0.VNPMIXM release-keys";
        fingerprint = "POCO/peridot_global/peridot:14/UKQ1.240624.001/OS2.0.102.0.VNPMIXM:user/release-keys";
        marketname = "POCO F6";
        model = "24069PC21I";
    } else if (region == "GL") {
        device = "peridot";
